...
public abstract class Recycler<T> {
    ...
    private static final class WeakOrderQueue {
        ...
        protected void finalize() throws Throwable {
            ...
            // We need to reclaim all space that was reserved by this WeakOrderQueue so we not run out of space in the
            // stack. This is needed as we not have a good life-time control over the queue as it is used in a
